...
// Filter routes
router.get('/count-by-blood-group', FilterController.BloodGroupHandler);
router.get('/count-by-gender', FilterController.GenderCountHandler);
router.get('/count-by-department', FilterController.DonorCountHandler);
router.get('/count-by-venue', FilterController.VenueCountHandler);
